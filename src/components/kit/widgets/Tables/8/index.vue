    ...
    <div class="d-flex flex-wrap">
      <div class="flex-grow-1 d-flex flex-column flex-sm-row mb-4">
        ...
        <div class="ml-sm-auto mr-lg-auto pr-3">
          ...
          <br />San Francisco, CA, 94107 <br />E-mail: example@amazon.com <br />Phone: (123) 456-7890 <br />Fax:
          800-692-7753
        </div>
      </div>
      <div class="flex-grow-1 d-flex flex-column flex-sm-row mb-4">
        ...
        <div class="mt-auto mt-sm-0 ml-sm-auto pr-3 mr-lg-auto">
          795 Folsom Ave, Suite 600
          <br />San Francisco, CA, 94107 <br />P: (123) 456-7890 <br />Invoice Date: January 20, 2016 <br />Due Date:
          January 22, 2016
        </div>
      </div>
    </div>
