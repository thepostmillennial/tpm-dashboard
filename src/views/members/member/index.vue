<template>
  <div class="view members member">
    ...
    <div class="card max-width-900" v-if="member">
      <a-layout>
        <a-page-header
        ...
        <a-layout-content class="p-4 d-flex flex-column flex-md-row">
          ...
          <a-form-model class="p-3 flex-grow-1 border rounded" :model="member" v-bind="config">
            ...
            <a-form-model-item label="Status" prop="status">
              <a-select v-model="member.systems.status" default-value="active">
            ...
            <a-form-model-item label="Source" prop="source">
              <a-select v-model="member.source" default-value="active">
                <a-select-option value="direct"> Direct </a-select-option>
                <a-select-option value="sso-google"> Google SSO </a-select-option>
                <a-select-option value="sso-facebook"> Facebook SSO </a-select-option>
                <a-select-option value="sso-twitter"> Twitter SSO </a-select-option>
              </a-select>
            </a-form-model-item>
